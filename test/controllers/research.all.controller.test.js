describe('researchAllCtrl', function() {
    ...
    beforeEach(inject(function($controller, $rootScope, _authentication_, _$httpBackend_){
        ...
        projectRequestHandler = $httpBackend.when('GET', '/api/research').respond();
        ...
        createController = function() {
            return $controller('researchAllCtrl', {
                '$scope': scope
            });
        };
    }));
    ...
    it('get data', function () {
        ...
        $httpBackend.expectGET('/api/research');
